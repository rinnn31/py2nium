...
public class RefreshCommand extends CommandHandler {
    public RefreshCommand(String uri, HttpMethod method) {
        super(uri, method);
    }
    ...
    protected Py2niumResponse handle(HttpReq request) {
        ...
        return new Py2niumResponse(Py2niumResponse.SUCCESS, element.refresh(), null);
